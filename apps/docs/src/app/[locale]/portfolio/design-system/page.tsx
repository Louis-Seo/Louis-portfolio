...
const PRINCIPLE_ICONS: Record<string, React.ReactNode> = {
  ...
  layers: (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        d="M10 2.5L17.5 7.5L10 12.5L2.5 7.5L10 2.5Z"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinejoin="round"
      />
      <path
        d="M2.5 12.5L10 17.5L17.5 12.5"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
  ...
  zap: (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        d="M11 2L4 11.5H10L9 18L16 8.5H10L11 2Z"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
        ...
        <div className={styles.problemGrid}>
          <div className={styles.problemCard}>
            ...
            <p className={styles.problemText}>
              Different screens used different button sizes, colors, and spacing — with no single
              reference to align them.
            </p>
          </div>
          <div className={styles.problemCard}>
            ...
            <p className={styles.problemText}>
              Developers had to reverse-engineer spacing, colors, and states from static mockups
              every time.
            </p>
          </div>
          <div className={styles.problemCard}>
            ...
            <p className={styles.problemText}>
              Adding new features meant recreating patterns from scratch instead of reusing proven
              components.
            </p>
          </div>
        </div>
        ...
        <div className={styles.principleGrid}>
          {PRINCIPLES.map((p) => (
            <div key={p.title} className={styles.principleCard}>
              <div className={styles.principleIcon}>{PRINCIPLE_ICONS[p.icon]}</div>
          ...
          <div className={styles.radiusRow}>
            {RADIUS_TOKENS.map((r) => (
              <div key={r.name} className={styles.radiusItem}>
                <div className={styles.radiusShape} style={{ borderRadius: r.value }} />
          ...
          <div className={styles.archExplanation}>
            <div className={styles.archItem}>
              ...
              <p className={styles.archItemText}>
                Each Figma variant maps to a typed prop. Primary and Secondary are <code>type</code>{" "}
                values, not separate components.
              </p>
            </div>
            <div className={styles.archItem}>
              <h4 className={styles.archItemTitle}>Size Scale</h4>
              <p className={styles.archItemText}>
                Five size options from Large (48px) to 2xSmall (24px) — each with corresponding
                padding, font size, and minimum width.
              </p>
            </div>
            <div className={styles.archItem}>
              <h4 className={styles.archItemTitle}>State Management</h4>
              <p className={styles.archItemText}>
                Default, Hover, Clicked, and Disabled states are all defined in Figma and translate
                to CSS pseudo-classes and the disabled attribute.
              </p>
            </div>
            <div className={styles.archItem}>
      ...
      <ContentSection alternate>
        ...
        <div className={styles.showcaseGroup}>
          ...
          <p className={styles.showcaseNote}>
            Three main types serve the visual hierarchy: Primary for key actions, Secondary for
            supporting actions, and Tertiary for icon-only triggers.
          </p>
        ...
        <div className={styles.showcaseGroup}>
          ...
          <p className={styles.showcaseNote}>
            Five sizes cover all contexts — from prominent page actions (Large: 48px) to compact
            inline triggers (2xSmall: 24px).
          </p>
          <div className={styles.showcasePanel}>
        ...
        <div className={styles.showcaseGroup}>
          ...
          <p className={styles.showcaseNote}>
            Four interaction states are defined for every button variant. Hover and Clicked use
            darker shades from the same palette.
          </p>
          <div className={styles.showcasePanel}>
            <div className={styles.showcaseRow}>
              <span className={styles.showcaseRowLabel}>Primary</span>
      ...
      <ContentSection>
        ...
        <div className={styles.reflectionContent}>
          <p className={styles.reflectionText}>
            ...
            Building NL Wind taught me that the real value of a system is not in the components
            themselves, but in the agreements they encode: what sizes exist, how states behave,
            where tokens come from.
          </p>
          <p className={styles.reflectionText}>
            Structuring every component around typed props, explicit states, and registered tokens
            forced me to think like both a designer and a developer. The result is a system where
            every Figma variant has a direct counterpart in code — no ambiguity, no
            re-interpretation.
          </p>
          <p className={styles.reflectionText}>
            <span className={styles.reflectionHighlight}>
            ...
            When the foundation is solid — consistent tokens, clear component APIs, documented
            states — the entire team moves faster. Designers compose instead of redrawing.
            Developers implement instead of guessing. The product stays coherent as it grows.
          </p>
        </div>
      </ContentSection>
    </div>
