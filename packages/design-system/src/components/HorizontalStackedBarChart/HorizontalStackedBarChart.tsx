...
import styles from "./HorizontalStackedBarChart.module.css";
...
export type HorizontalStackedBarSize = "small" | "medium" | "large";

export interface HorizontalStackedSeries {
...
export interface HorizontalStackedBarChartProps {
  ...
  categories: string[];
  /** Data series — each series adds one segment per row (max 6) */
